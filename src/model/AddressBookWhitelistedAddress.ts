...
import { AddressBookWhitelistedAddressInfo } from './AddressBookWhitelistedAddressInfo';

export type AddressBookWhitelistedAddress = {
  id: string;
  address: string;
  addressInfo: AddressBookWhitelistedAddressInfo;
  currency: string;
  label: string;
  displayAddress: string;
  addressBooked: boolean;
  addressBookAddedAt: Date;
  addressBookEntryPendingUntil?: Date;
  /**
